...
<Tabs>
	<Tab title="TypeScript">
		...
		//
		// `RIVET_DEV_TOKEN` is generated with `rivet init`. This will use
		// tokenless authentication in production.
		...
		<Warning>
			Read more about Rivet tokens [here](/general/concepts/handling-game-tokens).

			Read more about development tokens [here](/general/concepts/dev-tokens).
		</Warning>
	</Tab>
	<Tab title="C#">
		Coming soon
