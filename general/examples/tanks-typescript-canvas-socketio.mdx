...
// `RIVET_DEV_TOKEN` was generated while running `rivet init`. This will use
...
<Info>
    In production, `RIVET_DEV_TOKEN` will be `undefined` and instead will use [tokenless authentication](/general/concepts/tokenless-authentication-web).

    Read more about Rivet tokens [here](/general/concepts/handling-game-tokens). Read more about development tokens [here](/general/concepts/dev-tokens).
</Info>
